...
**採点基準 (0-10):**
配信する価値 = 深刻さ **または** 珍しさ・面白さ で採点する。両者を独立に評価。

- 9-10: 一大事。金融市場・国政・国際情勢を大きく動かす。歴史的節目。
- 7-8:  重要。政策決定、要人発言、企業M&A、大災害、外交合意など多くの人に直接影響。
- 5-6:  中程度。特定分野では重要だが影響範囲は限定。**または** 珍しい・まぬけな・不条理な事件/犯罪
  (例: 泥棒が置き手紙を残す、詐欺犯が交番に道を尋ねる、酔って自宅と間違えて他人宅で寝ていた、
   マンホールから車を釣る、コンビニ強盗が店員に説教される、犯人が SNS で自首、動物が絡む珍事件など)。
  「思わず二度見する」「読み手が笑える or 呆れる」ニュースは 6 を目安に。
